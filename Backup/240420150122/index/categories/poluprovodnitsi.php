...
<div id="container">
    ...
    <aside id="left-side">
        <nav>
            <h3>Каталог</h3>
            <ul>
                <li id="category1" style="background-color: palevioletred;
                border-radius: 10px 0 10px 0;"><a href="poluprovodnitsi.php">Полупроводници</a></li>
                ...
                <li id="category17"><a href="drugi.php">Други</a></li>
            </ul>
